/*
  ...
  1. Changes
    ...
    - Ensure proper access for both users and admins
*/
...
-- Create a policy for users to update their own submissions
...
-- Create a policy for admins to manage all submissions
